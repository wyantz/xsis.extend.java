		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li><a href="categories.html"><i class="fa fa-list"></i><span>Category</span></a></li>
					<li><a href="suppliers.html"><i class="fa fa-building"></i><span>Supplier</span></a></li>
					<li><a href="items.html"><i class="fa fa-briefcase"></i><span>Items</span></a></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>Inventory</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a href="summary.html"><i class="fa fa-circle-o"></i>Sumarry</a></li>
							<li><a href="purchaseorder.html"><i
									class="fa fa-circle-o"></i>Purchase Order</a></li>
							<li><a href="transferstock.html"><i class="fa fa-money"></i>Transfer
									Stock</a></li>
							<li><a href="adjustment.html"><i class="fa fa-money"></i>Adjustment</a></li>
						</ul></li>
					<li><a href="payment.html"><i class="fa fa-money"></i><span>Payment</span></a></li>
					<li><a href="employee.html"><i class="fa fa-user"></i><span>Employee</span></a></li>
				</ul>
			</section>
			<!-- /.sidebar -->
		</aside>
